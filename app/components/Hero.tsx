...
export default function Hero() {
  const { hero } = data;
  return (
    <section id="hero" className="relative bg-white dark:bg-black overflow-hidden">
      ...
      <div className="lg:absolute lg:inset-y-0 lg:left-0 lg:w-1/2 bg-gray-100 dark:bg-zinc-800">
        <div className="h-96 w-full sm:h-[30rem] md:h-[40rem] lg:w-full lg:h-full relative overflow-hidden">
          <Image
            src={hero.image}
            alt={hero.imageAlt}
            fill
